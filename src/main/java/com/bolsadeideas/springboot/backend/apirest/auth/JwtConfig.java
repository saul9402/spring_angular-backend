...
/**
 * Aqui se definen las contraseñas a usar para firmar el token. La que dice
 * "LLAVE_SECRETA" se utiliza para una firma "sencilla" que utiliza el algorimo
 * "HS256" para cifrar.
 * 
 * Las que dicen "RSA_PRIVADA" y "RSA_PUBLICA" se utilizan para un cifrado un
 * poco más robusto y seguro que es, precisamente, RSA, usando la llave privada
 * para firmar el token y la llave publica para verficar dicha firma. Ambas
 * fuerón generadas con OpenSSL.
 * 
 * @author Saul Avila
 *
 */
